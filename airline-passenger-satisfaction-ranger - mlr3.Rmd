...
search_space <- ParamSet$new(params = list(
  "max.depth" = ParamInt$new("max.depth", lower = 0, upper = 1), #Jule
  "mtry" = ParamInt$new("mtry", lower = 3, upper = 4) #Deniz
  #"num.trees" = ParamInt$new("num.trees", lower = 200, upper = 200), #Deniz
  #"respect.unordered.factors" = ParamFct$new("respect.unordered.factors", levels = c("ignore", "order", "partition")), #Michael
  #"replace" = ParamLgl$new("replace") #Michael
  #"min.node.size" = ParamInt$new("min.node.size", lower = 1, upper = 100), #Maike
  #"importance" = ParamFct$new("importance", levels = c("none", "permutation", "impurity")) #Maike
))
