...
ps <- makeParamSet(makeIntegerParam("mtry", 1, 13),
                   makeIntegerParam("num.trees", 2, 202))
...
plt = plotHyperParsEffect(data, x = "num.trees", y= "mtry", z = "mmce.test.mean",  plot.type = "heatmap")
